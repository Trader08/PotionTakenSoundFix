...
------------------------------------------------------------------------------------------------------------
    ...
    { name = "Major Resolve", 	description = "Increase Physical Resistance by 5280", },
    { name = "Major Ward", 	description = "Increase Spell Resistance by 5280", },
...
PTSF.buffs_abilityIds          = { --We're doing it this way so we'll be able to do a direct string compare instead of looping within arrays. We want to keep performance hit to a minimim
	...
	[64564] = "Major Resolve",				--crafted (currently missing in LibPotionBuff)
	[64562] = "Major Ward",					--crafted
...
if(PTSF.debug or debug_buffs) then
		local count = 0
		local text = ""
		local abilityIds = {}
